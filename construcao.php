...
<head>
  ...
  <meta property="og:title" content="Norte Link - SinCom Construção" />
...
<body>
  ...
  <section class="swiper swiper_banners lg:w-full">
    <div class="swiper-wrapper">
        <div class="w-full swiper-slide">
            ...
            <img class="lg:hidden block w-full" src="./assets/img/Banners construçãoMobilecopia.jpg" />
        </div>
        <div class="w-full swiper-slide">
            <img class="hidden lg:block w-full" src="./assets/img/Bannersconstrução2Desktop.jpg" />
            <img class="lg:hidden block w-full" src="./assets/img/Banners construção2Mobilecopia.jpg" />
        </div>
    </div>
  ...
  <section class="mx-auto max-w-4xl px-2 pt-4 mt-5">
    ...
    <div class="grid lg:grid-cols-2 gap-9 pt-20">
