...
<body class="bg-color2">
  <div class="mx-auto max-w-xl p-4">
    ...
    <a href="sincon/calcados.php">
      <div class="flex justify-center mt-4">
        <button class="animate-fade-in-2 rounded-3xl bg-color1 py-4 px-4 w-full text-white">CALÇADOS</button>
      </div>
    </a>
    <a href="sincon/supermercado.php">
      <div class="flex justify-center mt-4">
        <button class="animate-fade-in-3 rounded-3xl bg-color1 py-4 px-4 w-full text-white">SUPERMERCADO</button>
      </div>
    </a>
    <div class="flex justify-center mt-4">
      <button class="animate-fade-in-4 rounded-3xl bg-color1 py-4 px-4 w-full text-white">CONTATO</button>
    </div>
  </div>
