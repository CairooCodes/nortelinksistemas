  ...
  <section class="swiper swiper_banners">
    <div class="swiper-wrapper">
      <div class="swiper-slide shadow">
        <img class="hidden lg:block w-full" src="<?php echo $URI->base("/admin/uploads/banners/bannersicondesktop.jpg"); ?>" />
        <img class="lg:hidden block w-full" src="<?php echo $URI->base("/admin/uploads/banners/bannersiconmobile.jpg"); ?>" />
      </div>
    </div>
  </section>
